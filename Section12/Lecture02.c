...
int main()
{
	...
	*/
	...
	int* pt = &var_name;	// pt is and identifier.
	*pt = 1;				// *pt is not an identifier. *pt designates an object.
	
	int arr[100] = {0, };		// arr is an identifier. Is arr an object?	
	...
	*(arr + 2 * var_name) = 456;	// lvalue expression
	...
	const char* str = "Constant string";	// str is a modifiable lvalue. // notice the position of const
